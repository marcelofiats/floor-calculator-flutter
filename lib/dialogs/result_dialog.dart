    ...
    return AlertDialog(
      ...
      content: Wrap(
        children: [
          ...
          ListTile(
            title: Text(
                '${result.priceAllFloorWithoutFooter.toStringAsFixed(2)} R\$'),
            subtitle: Text('Valor Total sem rodapé'),
          ),
          ListTile(
            title: Text(
                '${result.priceAllFloorWithFooter.toStringAsFixed(2)} R\$'),
            subtitle: Text('Valor Total com rodapé'),
          ),
        ],
      ),
      actions: [
